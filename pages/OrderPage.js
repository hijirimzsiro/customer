...
const menu = [
  { id: '原味紅豆餅', name: '原味紅豆餅', price: 15, imgUrl: './images/redbean.png' },
  { id: '奶油餅', name: '奶油餅', price: 15, imgUrl: './images/cream.png' },
  { id: '花生餅', name: '花生餅', price: 15, imgUrl: './images/cream.png' },
  { id: '巧克力餅', name: '巧克力餅', price: 20, imgUrl: './images/choco.png' },
  { id: 'OREO鮮奶油餅', name: 'OREO鮮奶油餅', price: 20, imgUrl: './images/cream.png' },
  { id: '可可布朗尼餅', name: '可可布朗尼餅', price: 20, imgUrl: './images/cream.png' },
  { id: '紅豆麻糬餅', name: '紅豆麻糬餅', price: 20, imgUrl: './images/cream.png' },
  { id: '抹茶麻糬餅', name: '抹茶麻糬餅', price: 20, imgUrl: './images/cream.png' },
  { id: '黑芝麻鮮奶油餅', name: '黑芝麻鮮奶油餅', price: 20, imgUrl: './images/cream.png' },
  { id: '珍珠鮮奶油餅', name: '珍珠鮮奶油餅', price: 20, imgUrl: './images/cream.png' },
];
